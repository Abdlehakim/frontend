...
const Popup: React.FC <PopupProps>= ({handleClosePopup,Delete,id,name}) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-[10px] w-full max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg bg-white">
          <div className="text-center flex flex-col gap-[10px] justify-center">
            <p className="text-lg text-gray-500">
              Do you really want to delete < span className="text-red-500 font-bold">  {name}</span> ? <br/> 
              to confirm type  <span className="text-red-500 font-bold">DELETE</span>:
            </p>
            <input 
             value={inputValue}
